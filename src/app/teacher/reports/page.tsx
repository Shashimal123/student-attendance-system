...
export default function TeacherReportsPage() {
  ...
  const fetchReports = async () => {
    try {
      ...
      const response = await fetch(`/api/teacher/reports/attendance?${params}`, {
        headers: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">My Attendance Reports</h1>
                <p className="text-gray-600">View attendance data for your courses</p>
              </div>
            </div>
